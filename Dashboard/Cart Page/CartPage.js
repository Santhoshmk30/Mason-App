...
const CartPage = (item ) => {
  ...
  const [cartItems, setCartItems] = useState([
    { id: "1", name: "Ultratech OPC Cement 50kg", quantity: 1, price: 350 },
    { id: "2", name: "Ultratech OPC Cement 50kg", quantity: 1, price: 350 },
    { id: "3", name: "Ultratech OPC Cement 50kg", quantity: 1, price: 350 },
  ]);
  ...
  const renderCartItem = ({ item }) => (
    ...
    <View style={styles.cartItem}>
      ...
      <Image source={require('../icons/Cement.jpg')} style={styles.itemImage} />
  ...
  return (
    ...
    <View style={styles.container}>
         ...
         <View style={styles.card}>
            ...
            <View style={styles.card}>
                ...
                <View style={styles.billRow}>
                    ...
                    <Text style={styles.billValue}>₹499.00</Text>
                </View>
      ...
      <View style={styles.footer}>
        <Text style={styles.itemCount}>1 item Selected</Text>
        <TouchableOpacity style={styles.payButton}>
          <Text style={styles.payButtonText}>Pay ₹599.00</Text>
        </TouchableOpacity>
      </View>
...
const styles = StyleSheet.create({
  ...
  itemCount: { color: "#fff", fontSize: 16 },
  payButton: { backgroundColor: "#fff", padding: 10, borderRadius: 5 },
  payButtonText: { fontSize: 16, color: "#f60138" },
cardContainer: {
    backgroundColor: '#fff',
    borderRadius: 25,
    margin:10,
