...
const CementPage =({ navigation,item, increaseQuantity, decreaseQuantity  }) => {
  ...
  return (
    ...
    <TouchableOpacity onPress={() => navigation.navigate('CementPage')} style={styles.item}>
        <Image
            source={require('../icons/Cement.jpg')}
            style={styles.image1}
            resizeMode="cover"
        />
        <Text style={styles.imageText}>PPC</Text>
    </TouchableOpacity>
    ...
    <TouchableOpacity onPress={() => navigation.navigate('CementPage')} style={styles.item}>
        <Image
            ...
            resizeMode="cover"
        />
        <Text style={styles.imageText}>PSC</Text>
    </TouchableOpacity>
    ...
    <TouchableOpacity onPress={() => navigation.navigate('CementPage')} style={styles.item}>
        <Image
            ...
            resizeMode="cover"
        />
        <Text style={styles.imageText}>OPC</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => navigation.navigate('CementPage')} style={styles.item}>
        <Image
            source={require('../icons/Cement.jpg')}
            ...
            resizeMode="cover"
        />
        <Text style={styles.imageText}>White Cement</Text>
    </TouchableOpacity>
    <TouchableOpacity onPress={() => navigation.navigate('CementPage')} style={styles.item}>
        <Image
            source={require('../icons/Cement.jpg')}
            ...
            resizeMode="cover"
        />
        <Text style={styles.imageText}>Composite</Text>
    </TouchableOpacity>
</View>
<View style={styles.section}>
    <TouchableOpacity onPress={() => navigation.navigate('CementPage')} style={styles.item}>
        <Image
            ...
            resizeMode="cover"
        />
        <Text style={styles.imageText}>Putty</Text>
    </TouchableOpacity>
    ...
    <TouchableOpacity onPress={() => navigation.navigate('CementPage')} style={styles.item}>
        <Image
            ...
            resizeMode="cover"
        />
        <Text style={styles.imageText}>Ready Mix Plaster</Text>
    </TouchableOpacity>
</View>
